...
0. Look first. Two screenshots of https://cinema.wzrrd.sh about ten seconds apart, read them, then judge against the hard floor in the stance page before reading any ledger or pane. A ledger row is not evidence of an image. This rule exists because on 2026-09-14 ten sweeps called a static title card in a black void "ok" from the ledger alone.

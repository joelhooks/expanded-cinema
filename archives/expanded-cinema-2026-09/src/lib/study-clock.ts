...
/**
 * Study: clock-01 — branches recursion-01: keeps webgpu+o11y+starter+
 * delay ring+pastCamera; changes: three-layer frame (source now / memory
 * past / live pointer cut), no captions doing the work.
 * Antecedent: Marclay The Clock (2010, source map) — remix ruled by a clock.
 * Material: "Conquer by the Clock" (1943, Prelinger, CC PD) — first
 * internet-sourced material in the lane; same operation, different clock.
 */

const STUDY = "clock-01";
